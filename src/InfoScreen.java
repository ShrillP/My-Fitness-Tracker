...
public class InfoScreen extends JFrame implements ActionListener, MouseListener {
    ...
    private JLabel bodyImage = new JLabel(new ImageIcon("res/BodyImages/bodymuscleimage.png"));
    ...
    JLabel chestExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/chest.png"));
    JLabel backExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/back.png"));
    JLabel legExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/leg1.png"));
    JLabel legExerciseLabel2 = new JLabel(new ImageIcon("res/BodyImages/leg2.png"));
    JLabel shoulderExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/shoulder1.png"));
    JLabel shoulderExerciseLabel2 = new JLabel(new ImageIcon("res/BodyImages/shoulder2.png"));
    JLabel bicepExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/bicep.png"));
    JLabel tricepExerciseLabel = new JLabel(new ImageIcon("res/BodyImages/tricep.png"));
